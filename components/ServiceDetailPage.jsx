        ...
        <div className="aq-wrap">
          <div className="aq-service-grid">
            ...
            <div className="aq-panel">
              ...
              <div className="aq-service-metrics"><div className="aq-metric"><div className="k">Baseline</div><div className="v">30–40 h</div></div><div className="aq-metric"><div className="k">KPIs</div><div className="v">OEE · SLA</div></div></div>
              <div className="aq-chart" style={{ marginTop: 18 }}><LineChart data={[38,42,48,47,56,62,68,72,80,84,88,91]} /></div>
              <div className="aq-panel-foot"><span>Baseline</span><span>Target KPI</span><span>SLA</span></div>
            </div>
          </div>
        </div>
      </section>
