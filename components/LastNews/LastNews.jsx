    ...
    return (
      <section className="py-8 text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {posts.map((post) => (
            <Link href={`/blogs/${post.slug}`} key={post.slug} className="block bg-white rounded-md shadow-md hover:shadow-lg transition-shadow duration-300">
              ...
              <div className="p-4">
                ...
                <p className="text-gray-700 mb-4 line-clamp-3">{post.frontMatter.description}</p>
