...
const EthicsPolicy = () => {
  return (
    <div className="p-8 rounded-lg max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Política de Ética Empresarial</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">2. Valores Corporativos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">3. Principios de Ética</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">4. Conducta Esperada</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">5. Cumplimiento Legal</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">6. Formación y Capacitación</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">7. Denuncias y Reclamaciones</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">8. Responsabilidad de los Empleados</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">9. Contacto</h2>
      <p className="mb-4 dark:text-gray-200">
