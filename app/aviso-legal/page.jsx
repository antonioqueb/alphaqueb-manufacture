...
const LegalNotice = () => {
  return (
    <div className="p-8 rounded-lg max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Aviso Legal</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">1. Identificación del Responsable</h2>
      <p className="mb-4 dark:text-gray-200">
        <strong>Razón Social:</strong> Alphaqueb Consulting SAS<br />
        <strong>Email:</strong> hola@alphaqueb.com<br />
      </p>
      
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">2. Objeto</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">3. Condiciones de Uso</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">4. Propiedad Intelectual</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">5. Limitación de Responsabilidad</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">6. Política de Privacidad</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">7. Enlaces a Otros Sitios Web</h2>
      <p className="mb-4 dark:text-gray-200">
