...
const COPY = {
  ...
  advantages: ["MTTR / Uptime: Prioriza lo que realmente puede detener la operación.", "Alertas tempranas: Detecta desviaciones antes de una falla mayor.", "Historial de eventos: Documenta patrones y decisiones.", "Mejor planeación: Mantenimiento con contexto, no solo calendario.", "Menos urgencias: Reduce correcciones improvisadas.", "Decisiones con evidencia: Justifica refacciones, ajustes o paros programados."],
