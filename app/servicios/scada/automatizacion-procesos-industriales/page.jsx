...
const COPY = {
  ...
  advantages: ["Consistencia: Menos variaciones entre turnos o responsables.", "Menos errores: Validaciones en pasos críticos.", "OEE / Uptime: Lo automatizado puede revisarse y medirse desde operación.", "Mejor respuesta: Alertas ante condiciones fuera de rango.", "Integración: Conexión con reportes o sistemas internos.", "Escalabilidad: Automatización por etapas según prioridad."],
