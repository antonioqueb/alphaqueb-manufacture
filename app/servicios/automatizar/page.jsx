...
const COPY = {
  ...
  advantages: ["Menos errores manuales: Reducimos capturas repetidas, pasos ambiguos y dependencias de memoria operativa.", "SLA operativo: Convertimos procesos críticos en rutas medibles, con tiempos objetivo y responsables claros.", "Ahorro de tiempo: Quitamos carga operativa donde el equipo repite tareas que un sistema puede resolver mejor.", "Control por etapas: Automatizamos lo que tiene sentido primero y dejamos espacio para crecer sin rehacer todo.", "Integración de información: Conectamos datos de operación, inventario, administración o proveedores cuando el flujo lo requiere.", "Adopción real: Diseñamos pensando en las personas que usarán el sistema todos los días."],
