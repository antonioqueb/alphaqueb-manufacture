...
const AcceptableUsePolicy = () => {
  return (
    <div className="p-8 rounded-lg max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Política de Uso Aceptable de Recursos Tecnológicos</h1>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">1. Introducción</h2>
      <p className="mb-4">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">2. Alcance</h2>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">3. Uso Responsable de los Recursos Tecnológicos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">4. Protección de Datos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">5. Uso de Internet y Correo Electrónico</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">6. Monitoreo y Auditoría</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">7. Consecuencias de la Infracción</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">8. Formación y Capacitación</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">9. Cambios en la Política</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">10. Contacto</h2>
      <p className="mb-4 dark:text-gray-200">
