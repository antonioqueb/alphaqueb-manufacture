...
const PrivacyPolicy = () => {
  return (
    <div className="p-8 rounded-lg  max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Aviso de Privacidad</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Información que Recopilamos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Cómo Usamos tu Información</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Compartir tu Información</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Protección de la Información</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Tus Derechos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">Cambios en este Aviso de Privacidad</h2>
      <p className="mb-4 dark:text-gray-200">
