...
const ExternalLinksPolicy = () => {
  return (
    <div className="p-8 rounded-lg max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Política de Enlaces Externos</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">1. Objetivo de la Política</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">2. Uso de Enlaces Externos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">3. Responsabilidad de los Enlaces Externos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">4. Política de Enlaces Recíprocos</h2>
      <p className="mb-4 dark:text-gray-200">
        ...
        <ul className="list-disc ml-6 mt-2 dark:text-gray-200">
          <li>El enlace debe dirigirse a la página principal de nuestro sitio web (<a href="https://www.alphaqueb.com" className="text-orange-500 hover:underline  dark:text-gray-200">https://www.alphaqueb.com</a>).</li>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2  dark:text-gray-200">5. Remoción de Enlaces</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">6. Cambios en la Política</h2>
      <p className="mb-4 dark:text-gray-200">
