...
const DataProtectionPolicy = () => {
  return (
    <div className="p-8 rounded-lg max-w-4xl mx-auto dark:text-gray-200">
      <h1 className="text-3xl font-bold mb-6 text-center dark:text-gray-200">Política de Protección de Datos Personales</h1>
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">1. Información que Recopilamos</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">3. Compartir Información</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">4. Protección de la Información</h2>
      <p className="mb-4 dark:text-gray-200">
      ...
      <h2 className="text-2xl font-semibold mt-6 mb-2 dark:text-gray-200">6. Cambios en esta Política de Protección de Datos Personales</h2>
      <p className="mb-4 dark:text-gray-200">
